                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                ...
                                <input type="password" required name="new_password" class="form-control form-control-lg" id="password">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-label-group">
