                                    ...
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            ...
                                            <div class="nk-block-des text-soft">
                                                <p>
                                                    This module allows you to manage enquiries<br>
                                                </p>
                                            </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $rows['inquiry_email']; ?></td>
                                                                    <td><?php echo $rows['inquiry_phone']; ?></td>
                                                                    <td><?php echo $rows['inquiry_subject']; ?></td>
                                                                    <td><?php echo $rows['inquiry_msg']; ?></td>
                                                                    <td>
                                                                        <a data-toggle="modal" href="#update_<?php echo $rows['inquiry_id']; ?>" class="badge badge-dim badge-pill badge-outline-secondary"><em class="icon ni ni-edit"></em> View</a>
                                                                    </td>
                                                                </tr>
                                                        <?php
                                                                $cnt = $cnt + 1;
