...
while ($mailer = $res->fetch_object()) {
    ...
    if ($mailer->mailer_status == 'Active') {
        ...
        $mail->Subject = 'Welcome to ECDE MIS';
        /* Custom Mail Body */
        $mail->Body = '
        <!doctype html>
        <html lang="en-US">
                                        ...
                                        <tr>
                                            <td style="padding:0 35px;">
                                                ...
                                                <p style="color:#455056; font-size:15px;line-height:24px; margin:0;" align="justify">
                                                    ...
                                                    Welcome to Government of Makueni County ECDE MIS. 
                                                    Your account has been set up. You can now login to the ' . $user_access_level . ' portal using the following credentials <br>
                                                    <b>

                                                        Login url: <a target="_blank" href="https://ecde.makueni.go.ke">https://ecde.makueni.go.ke</a> <br>
