...
!(function (NioApp, $) {
  ...
  var deviceStatusData = {
    ...
    datasets: [
      {
        borderColor: "#fff",
        background: ["#9cabff", "#ffdd00", "#7de1f8"],
        data: [84.5, 14.2, 1.3],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        color: "#124491",
        background: NioApp.hexRGB("#124491", 0.25),
    ...
    datasets: [
      {
        label: "Social Media",
        color: "#ffdd00",
        background: NioApp.hexRGB("#ffdd00", 0.25),
        data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95],
      },
    ],
  };
    ...
    datasets: [
      {
        label: "Pageviews",
        color: "#9a89ff",
        background: NioApp.hexRGB("#9a89ff", 0.25),
        data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95],
      },
    ],
  };
    ...
    datasets: [
      {
        ...
        data: [
          ...
          4350, 4600, 5200, 5650, 6850, 6950, 4150, 4300, 6000, 6800, 2250,
          6900, 7950, 6900, 4200, 6250, 7650, 8950, 9750,
        ],
      },
      {
        label: "Current Month",
        color: "#124491",
        dash: 0,
        background: NioApp.hexRGB("#124491", 0.15),
        data: [
          4110, 4220, 4810, 5480, 4600, 5670, 6660, 4830, 5590, 5730, 4790,
          4950, 5100, 5800, 5950, 5850, 5950, 4450, 4900, 8000, 7200, 7250,
          7900, 8950, 6300, 7200, 7250, 7650, 6950, 4750,
        ],
      },
    ],
  };
