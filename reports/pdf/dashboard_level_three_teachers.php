                ...
                <body style="margin:1px;">
                    ...
                    <div class="list_header" align="center">
                        <h3>
                            ...
                            '.$ward.' Ward ECDE Teachers Breakdown Per Centers<br>
                        </h3>                        
                    </div>
                    <table border="1" cellspacing="0" width="100%" style="font-size:9pt">
                        <thead>
                            <tr>
                                ...
                                <th style="width:100%">Teacher Name</th>
                                <th style="width:50%">Contacts</th>
                                <th style="width:50%">Gender</th>
                                <th style="width:50%">P Number</th>
                                    ...
                                    while ($row = mysqli_fetch_array($pdf_sql)) {
                                        $html .=
                                            ...
                                            <tr>
                                                ...
                                                <td>' . $row['user_employment_category'] . '</td>
                                            </tr>';
                                        $cnt++;
                                    }
                                }
...
$dompdf->render();
$dompdf->stream($ward . ' ECDE Teachers', array("Attachment" => 1));
