    ...
    <body style="margin:1px;">
        ...
        <div class="list_header">
            <h3>
                ...
                ' . $ward . ' Ward Enrollments Breakdown Per ECDE Center<br>
            </h3>                        
        </div>
        <table border="1" cellspacing="0" style="font-size:9pt">
            ...
            $pdf_sql = mysqli_query($mysqli, "SELECT * FROM ecde_centers WHERE center_ward_id = '{$id}'");
            $cnt = 1;
            $total_baby_class = 0;
            $total_pp1 = 0;
            $total_pp2 = 0;
...
$dompdf->render();
$dompdf->stream($ward . ' Ward Enrollments Breakdown Per ECDE Center', array("Attachment" => 1));
