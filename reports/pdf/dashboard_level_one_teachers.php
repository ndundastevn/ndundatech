                ...
                <body style="margin:1px;">
                    ...
                    <div class="list_header" align="center">
                        <h3>
                            ...
                            ECDE Teachers Breakdown Per Subcounties<br>
                        </h3>                        
                    </div>
                            ...
                            ';
                                ...
                                if (mysqli_num_rows($pdf_sql) > 0) {
                                    while ($row = mysqli_fetch_array($pdf_sql)) {
                                           ...
                                           INNER JOIN ward w ON w.ward_id = ec.center_ward_id
                                           WHERE w.ward_sub_couty_id = '{$row['sub_county_id']}' 
...
$dompdf->render();
$dompdf->stream('ECDE Teachers Breakdown Per Subcounties', array("Attachment" => 1));
