                ...
                <body style="margin:1px;">
                    ...
                    <div class="list_header" align="center">
                        <h3>
                            ...
                            ECDE MIS  <br>
                            Authentication Logs From ' . date('d M Y', strtotime($formated_from_date)) . ' To ' . date('d M Y', strtotime($formated_to_date)) . ' <br>
                        </h3>                        
                    </div>
                        ...
                        <tbody>
                            ';
                                $pdf_sql = mysqli_query(
                                    ...
                                    WHERE l.log_date BETWEEN '{$formated_from_date}' 
                                    AND '{$formated_to_date}' ORDER BY l.log_id DESC"
                                );
                                $cnt = 1;
...
$dompdf->render();
$dompdf->stream('Authentication Logs From ' . $formated_from_date . ' To ' . $formated_to_date, array("Attachment" => 1));
