 ...
 */
                 ...
                 <body style="margin:1px;">
                     ...
                     <div class="list_header">
                         <h3>
                             ...
                             ' . $subcounty . ' Subcounty ECDE Centers<br>
                         </h3>                        
                     </div>
                             ...
                             ';
                                 ...
                                 if (mysqli_num_rows($pdf_sql) > 0) {
                                     while ($row = mysqli_fetch_array($pdf_sql)) {
                                         ...
                                         WHERE center_ward_id = '{$row['ward_id']}'
                                         ...
                                         $html .=
                                             ...
                                             <tr>
                                                 ...
                                                 <td>' . number_format($public_centers) . '</td>
                                                 <td>' . number_format($private_centers) . '</td>
                                             </tr>
                                         ';
                                         $cnt++;
                                     }
                                 ...
                                 $html .= '
                                     <tr id="total_row">
                                         ...
                                         <td>' . number_format($total_public) . '</td>
                                         <td>' . number_format($total_private) . '</td>
                                     </tr>
                                 ';
                                 $html .= '
                         </tbody>
 ...
 $dompdf->render();
 $dompdf->stream($subcounty . ' Subcounty ECDE Centers', array("Attachment" => 1));
